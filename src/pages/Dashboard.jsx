  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card p-5">
        ...
        {showAddShortcut && (
          <form onSubmit={handleAddShortcut} className="mb-4 flex gap-2 animate-slide-up p-3 bg-dark-700/30 rounded-xl border border-dark-600/30">
            ...
            <input type="text" placeholder="Emoji (ex: 🚀)" value={newShortcut.icon} onChange={e => setNewShortcut({...newShortcut, icon: e.target.value})} className="w-16 px-3 py-1.5 bg-dark-700/50 border border-dark-600/50 rounded-lg text-white text-xs text-center" />
