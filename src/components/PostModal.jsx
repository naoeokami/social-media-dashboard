                    ...
                    <div className="relative flex-1 bg-black">
                      ...
                      <div className="absolute top-4 left-0 w-full px-3 flex items-center justify-between z-30">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-full bg-brand-500 border border-white/20 shadow-lg flex items-center justify-center">
                            <span className="text-white text-[10px] font-bold">G3</span>
                          </div>
                          <span className="text-white text-xs font-semibold drop-shadow-md">suamarca</span>
                    ...
                    <div className="relative flex-1 bg-black">
                      ...
                      <div className="absolute bottom-0 left-0 w-[85%] p-4 z-30 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
                        <div className="flex items-center gap-2 mb-2">
                          <div className="w-7 h-7 rounded-full bg-brand-500 border border-white/20 shadow-lg flex items-center justify-center">
                            <span className="text-white text-[10px] font-bold">G3</span>
                          </div>
                          <span className="text-white text-xs font-semibold drop-shadow-md">suamarca</span>
                        ...
                        <div className="flex items-center gap-1 bg-white/20 w-fit px-2 py-1 rounded-full backdrop-blur-sm">
                          ...
                          <span className="text-white text-[9px] truncate max-w-[120px]">Áudio original - suamarca</span>
                        </div>
                      </div>
                    </div>
                  ) : (
                    <div className="flex-1 bg-dark-900 flex flex-col pt-6 relative">
                      <div className="flex items-center justify-between px-3 py-2 bg-dark-900">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-white text-xs font-semibold">suamarca</span>
                        </div>
                      ...
                      <div className="px-3 flex-1 overflow-y-auto no-scrollbar pb-4 bg-dark-900">
                        <p className="text-white text-[11px] leading-relaxed">
                          <span className="font-semibold mr-1.5">suamarca</span>
