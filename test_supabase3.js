...
async function test() {
  const longUrl = JSON.stringify([
    ...
    "https://zfdgswcbwigjqpbbrjqk.supabase.co/storage/v1/object/public/posts_images/d8c1c4f5-9a8b-4b21-8848-18eb9cd394b9-image2.jpg"
  ]);
  const { data, error } = await supabase.from('posts').update({ fileUrl: longUrl }).eq('id', '4d7fc07f-727e-4954-8a09-62de73ee7d11');
